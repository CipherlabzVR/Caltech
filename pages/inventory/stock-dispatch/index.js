...
export default function Dispatch() {
    ...
    const handleSearchChange = (event) => {
        ...
        setSearchTerm(value);
        setPage(1);
        fetchDispachList(1, value, pageSize);
    };

    const handlePageChange = (event, value) => {
        setPage(value);
        fetchDispachList(value, searchTerm, pageSize);
    };
    ...
    const handlePageSizeChange = (event) => {
        ...
        setPageSize(newSize);
        setPage(1);
        fetchDispachList(1, searchTerm, newSize);
    };
    ...
    const fetchDispachList = async (page = 1, search = "", size = pageSize) => {
        try {
            ...
            const query = `${BASE_URL}/StockBalance/GetAllStockDispatch?SkipCount=${skip}&MaxResultCount=${size}&Search=${search || "null"}`;
