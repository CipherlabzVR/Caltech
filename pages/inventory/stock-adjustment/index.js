...
export default function StockAdjustment() {
    ...
    const handleSearchChange = (event) => {
        ...
        setSearchTerm(value);
        setPage(1);
        fetchStockAdjustmentList(1, value, pageSize);
    };

    const handlePageChange = (event, value) => {
        setPage(value);
        fetchStockAdjustmentList(value, searchTerm, pageSize);
    };
    ...
    const handlePageSizeChange = (event) => {
        ...
        setPageSize(newSize);
        setPage(1);
        fetchStockAdjustmentList(1, searchTerm, newSize);
    };
    ...
    const fetchStockAdjustmentList = async (page = 1, search = "", size = pageSize) => {
        try {
            ...
            const query = `${BASE_URL}/StockAdjustment/GetAllStockAdjustment?SkipCount=${skip}&MaxResultCount=${size}&Search=${search || "null"}`;
                        ...
                        <Table aria-label="simple table" className="dark-table">
                            ...
                            <TableBody>
                                {stockAdjustmentList.length === 0 ? (
                                    ...
                                    stockAdjustmentList.map((item, index) => (
                                        <TableRow key={index}>
