...
export default function EditDeviceType({ item, fetchItems }) {
  ...
  const handleSubmit = (values) => {
    ...
    fetch(`${BASE_URL}/DeviceType/UpdateDeviceType`, {
      method: "POST",
      ...
      .then((data) => {
        ...
        if (sc === 200) {
          toast.success(msg || "Device type updated");
          handleClose();
          fetchItems?.();
        } else {
          toast.error(msg || "Failed to update device type");
        }
      })
      .catch((error) => {
