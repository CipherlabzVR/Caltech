...
export default function ECommerceNewsletterSubscribers() {
  ...
  const fetchAll = async () => {
    setLoading(true);
    try {
      const response = await fetch(`${BASE_URL}/ECommerce/GetAllNewsletterSubscribers`, {
        method: "GET",
  ...
  const handleToggle = async (row, isActive) => {
    try {
      const response = await fetch(`${BASE_URL}/ECommerce/ToggleNewsletterSubscriberStatus`, {
        method: "POST",
        headers: authJsonHeaders(),
  ...
  const handleDelete = async () => {
    ...
    try {
      const response = await fetch(
        `${BASE_URL}/ECommerce/DeleteNewsletterSubscriber?id=${toDelete.id}`,
  ...
  const handleExportExcel = () => {
    ...
    XLSX.writeFile(workbook, `ECommerce_Newsletter_Subscribers_${stamp}.xlsx`);
    ...
    <>
      <div className={styles.pageTitle}>
        ...
        <ul>
          ...
          <li>ECommerce</li>
          <li>
            <Link href="/ecom/newsletter-subscribers/">Newsletter</Link>
          </li>
        </ul>
      </div>
