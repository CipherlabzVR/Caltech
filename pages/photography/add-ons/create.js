...
export default function AddAddOn({ fetchItems }) {
  ...
  const handleSubmit = (values) => {
    ...
    fetch(`${BASE_URL}/PhotographyAddOn/CreateAddOn`, {
      method: "POST",
      ...
      .then((data) => {
        ...
        if (sc === 200 || sc === "SUCCESS") {
          toast.success(msg || "Add-on created");
          handleClose();
          fetchItems?.();
        } else {
          toast.error(msg || "Failed to create add-on");
        }
      })
      .catch((error) => {
