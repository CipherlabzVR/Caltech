...
export default function EditAddOn({ item, fetchItems }) {
  ...
  const handleSubmit = (values) => {
    ...
    fetch(`${BASE_URL}/PhotographyAddOn/UpdateAddOn`, {
      method: "POST",
      ...
      .then((data) => {
        ...
        if (sc === 200 || sc === "SUCCESS") {
          toast.success(msg || "Add-on updated");
          handleClose();
          fetchItems?.();
        } else {
          toast.error(msg || "Failed to update add-on");
        }
      })
      .catch((error) => {
