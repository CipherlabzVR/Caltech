...
const TEMPLATE_NAME = "Sales Order Print Template";
...
const SAMPLE_DATA = {
  ...
  documentNo: "SO-000231",
  customerName: "Kamal Fernando",
  orderDate: "30-Jun-2026",
  warehouseName: "Main Warehouse",
  salesPerson: "Nimal Silva",
  remark: "Deliver before month end",
  totalQty: "30",
  grossTotal: "33,500.00",
  netTotal: "33,500.00",
};

const SAMPLE_ROWS = [
  { productName: "A4 Copy Paper 80gsm", productCode: "ITM-1001", qty: "20", unitPrice: "850.00", lineTotal: "17,000.00" },
  { productName: "Blue Ball Pen", productCode: "ITM-1002", qty: "5", unitPrice: "45.00", lineTotal: "225.00" },
  { productName: "Stapler Heavy Duty", productCode: "ITM-1003", qty: "5", unitPrice: "1,250.00", lineTotal: "6,250.00" },
];
  ...
  const fetchTemplate = useCallback(async () => {
    try {
      ...
      if (response.ok && data) {
        ...
        toast.error(data?.message || "Failed to load the Sales Order print template.");
      }
    } catch (error) {
      console.error("Error loading report template:", error);
      toast.error("Failed to load the Sales Order print template.");
    } finally {
      setLoading(false);
    }
  }, [authHeaders]);
  ...
  return (
    <>
      ...
      <div className={styles.pageTitle}>
        <h1>Sales Order Print Template</h1>
        <ul>
          <li>
          ...
          <li>Sales Order Print Template</li>
        </ul>
      </div>
            ...
            <Paper sx={{ p: 1.5, height: "100%" }}>
              ...
              >
                <Box
                  component="iframe"
                  ref={iframeRef}
                  title="Sales Order template preview"
      ...
      <Dialog open={resetOpen} onClose={() => (saving ? null : setResetOpen(false))}>
        ...
        <DialogContent>
          <DialogContentText>
            This will permanently delete the custom Sales Order print template and restore the
