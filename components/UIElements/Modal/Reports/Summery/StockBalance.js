...
export default function StockBalance({ docName, reportName } = {}) {
  ...
  const openHtmlStatement = () => {
    ...
    openSummaryHtmlReport("/reports/stock-balance/print", params, reportMode === REPORT_MODE.EXCEL);
  };
  ...
  const modalTitle = summaryModalTitle("Stock Balance Report", reportMode);
