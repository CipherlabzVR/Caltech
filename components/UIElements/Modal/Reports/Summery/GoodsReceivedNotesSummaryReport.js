...
export default function GoodsReceivedNotesSummaryReport({ docName, reportName } = {}) {
  ...
  const openHtmlReport = () => {
    ...
    openSummaryHtmlReport("/reports/goods-received-notes-summary/print", params, reportMode === REPORT_MODE.EXCEL);
  };
  ...
  const modalTitle = summaryModalTitle("Goods Received Notes Summary Report", reportMode);
