...
export default function ShipmentSummaryReport({ docName, reportName } = {}) {
  ...
  const buildCrystalReportUrl = () => {
    const params = new URLSearchParams({
      ...
      reportName: shipmentSummaryReport || "",
      fromDate: fromDate || "",
      toDate: toDate || "",
  ...
  const openHtmlReport = () => {
    ...
    openSummaryHtmlReport("/reports/shipment-summary/print", params, reportMode === REPORT_MODE.EXCEL);
  };
  ...
  const modalTitle = summaryModalTitle("Shipment Summary Report", reportMode);
  ...
  return (
    <>
      ...
      <Modal
        open={open}
        onClose={handleClose}
        aria-labelledby="shipment-summary-report-title"
        aria-describedby="shipment-summary-report-description"
      >
