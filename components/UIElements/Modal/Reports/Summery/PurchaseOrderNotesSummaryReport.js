...
export default function PurchaseOrderNotesSummaryReport({ docName, reportName } = {}) {
  ...
  const openHtmlReport = () => {
    ...
    window.open(`/reports/purchase-order-notes-summary/print?${params.toString()}`, "_blank");
  };
  ...
  const modalTitle =
    reportMode === REPORT_MODE.CUSTOM
      ? "Purchase Order Notes Summary Report (Custom)"
      : "Purchase Order Notes Summary Report (Default)";
