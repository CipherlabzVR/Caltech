...
export default function CustomerPaymentSummaryReport({ docName, reportName } = {}) {
  ...
  const openHtmlReport = () => {
    ...
    openSummaryHtmlReport("/reports/customer-payment-summary/print", params, reportMode === REPORT_MODE.EXCEL);
  };
  ...
  const modalTitle = summaryModalTitle("Customer Payment Summary Report", reportMode);
